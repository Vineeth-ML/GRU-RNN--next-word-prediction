...
**Shakespeare's Hamlet** — sourced from [NLTK's Gutenberg corpus](https://www.nltk.org/book/ch02.html), which includes a selection of public-domain texts. The raw text is auto-downloaded when you run the notebook.
